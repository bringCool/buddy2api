...
fn linux_cmdline_is_codebuddy_cn(cmdline: &str) -> bool {
    ...
    if lower.contains("buddy2api") || lower.contains("buddy2api") {
        return false;
    }
...
mod tests {
    ...
    fn cn_image_name_is_exact_not_international_codebuddy() {
        ...
        assert!(!is_codebuddy_cn_image_name("buddy2api.exe"));
        assert!(!is_codebuddy_cn_image_name("buddy2api"));
...
";
    ...
    fn linux_cmdline_matcher_accepts_cn_not_switcher() {
        ...
        assert!(!linux_cmdline_is_codebuddy_cn("/usr/bin/buddy2api"));
        assert!(!linux_cmdline_is_codebuddy_cn(
    ...
    fn macos_cn_ps_filter_excludes_self_and_international() {
        ...
        let stdout = format!(
            "{self_pid} /Applications/buddy2api.app/Contents/MacOS/buddy2api\n\
             ...
             6003 /bin/zsh -c 'echo CodeBuddy CN.app mention via buddy2api'\n\
