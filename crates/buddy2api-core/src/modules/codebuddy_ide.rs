...
mod tests {
    ...
    fn ide_image_name_is_codebuddy_not_cn() {
        ...
        assert!(!is_codebuddy_ide_image_name("buddy2api.exe"));
...
";
    ...
    fn linux_cmdline_matcher_accepts_intl_not_cn_or_switcher() {
        ...
        assert!(!linux_cmdline_is_codebuddy_ide("/usr/bin/buddy2api"));
        assert!(!linux_cmdline_is_codebuddy_ide(
    ...
    fn macos_ide_ps_filter_excludes_self_and_cn() {
        ...
        let stdout = format!(
            "{self_pid} /Applications/buddy2api.app/Contents/MacOS/buddy2api\n\
             ...
             6003 /bin/zsh -c 'echo CodeBuddy.app mention via buddy2api'\n\
